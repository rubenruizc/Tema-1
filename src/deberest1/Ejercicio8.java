...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		...
		// Le preguntamos cuántas entradas infantiles desea
		System.out.println("¿Cuantas entradas infantiles desea?");

		// Leemos el número
		entradasI = sc.nextInt();

		// Le preguntamos cuántas entradas adultas desea
		...
		System.out.println("Tendrá que abonar un total de: " + importeTotal + " euros.");
		...
		// Le enseñamos al usuario su importe final con descuento en caso de que este
		// haya sido aplicado
